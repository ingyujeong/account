                ...
                <script>
                    ...
                    function addslipRow() {
                    	...
                    	$.ajax({ 
                            ...
                            success: function (jsonObj) {
                            	console.log("accountPeriodNo :"+accountPeriodNo +"///callResult: saarch");
                            	addslipShow();
                    ...
                    function createJournal() {
                        ...
                        gridOptions2 = {
                            ...
                            detailCellRendererParams: {
                                detailGridOptions: {
                                    ...
                                    onRowClicked: function (event) {  // 상위 테이블에 있는 상세보기버튼으로도 실행됨.(dong)
                                    	console.log("onRowClicked 실행111");
                            ...
                            onRowClicked: function (event) {
                            	console.log("onRowClicked 실행 분개의 상세");
                                selectedJournalRow = event.data;
		            	...
		            	var slipStatus= confirm=="승인요청" ? confirm : null //기본은 null이고 confirm할때만 "승인요청"으로 바뀐다
                   		...
                   		if( selectedSlipRow['slipStatus']=="승인요청" || selectedSlipRow['slipStatus']=="승인완료" ){
			                ...
			                gridOptions2.api.forEachNode(function (node, index) {
                                      console.log(node.data.journalNo+"@@@@@@@@@@@@@@@@"); //total
			                    	 if(node.data.journalNo !="Total"){
			                         JournalTotalObj.push(node.data); //분개노드 마지막 total 빼고 JournalTotalObj에 담음
			                         console.log(" JournalTotalObj.push(node.data) 11:" +JSON.stringify(node.data));
			                         console.log(" JournalTotalObj.push(node.data)22 :" +JSON.stringify(JournalTotalObj));
			                     }
			                });
	                        console.log(selectedSlipRow['slipNo']+"이게머노@@@@@@@@@@@@@@@@@@@@@@@");
...
/*                             pagination: true, // 페이저
                    ...
                    function createCodeGrid() {
                        ...
                        gridOptions5 = {
                            ...
                            onRowClicked: function (event) {
                            	console.log("onRowClicked 실행333");
